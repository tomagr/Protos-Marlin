...
#define LANGUAGE_CHOICE 9  // Pick your language from the list above
#endif
...
// LCD Menu Messages
	#define WELCOME_MSG MACHINE_NAME " Protos."
	#define MSG_SD_INSERTED "Memoria SD OK!"
	#define MSG_SD_REMOVED "Sin memoria SD"
	#define MSG_MAIN "inicio"
	#define MSG_AUTOSTART "Autostart"
	#define MSG_DISABLE_STEPPERS "Deshabilitar motores"
	#define MSG_AUTO_HOME "llevar a (0,0,0)"
...
// LCD Menu Messages
	#define WELCOME_MSG MACHINE_NAME " Protos."
	#define MSG_SD_INSERTED "Tarjeta SD ok!"
	#define MSG_SD_REMOVED "Sin Tarjeta SD"
	#define MSG_MAIN "Menu Principal \003"
	#define MSG_AUTOSTART "Autostart"
	#define MSG_DISABLE_STEPPERS "Apagar Motores"
	#define MSG_AUTO_HOME "Llevar ejes al Cero"
	...
	#define MSG_ZSTEPS "Zpasos/mm:"
	#define MSG_ESTEPS "Epasos/mm:"
	#define MSG_RECTRACT " Retraer     \x7E"
	#define MSG_TEMPERATURE "Temperatura    \x7E"
	#define MSG_MOTION "Movimiento     \x7E"
	#define MSG_STORE_EPROM "Guardar Memoria"
	#define MSG_LOAD_EPROM "Cargar Memoria"
	#define MSG_RESTORE_FAILSAFE "Rest. de emergencia"
	#define MSG_REFRESH "\004Volver a cargar"
	#define MSG_WATCH "Monitoreo \003"
	#define MSG_PREPARE "Preparar \x7E"
	#define MSG_TUNE "Ajustar \x7E"
	#define MSG_PAUSE_PRINT "Pausar Impresion \x7E"
	#define MSG_RESUME_PRINT "Reanudar Impresion \x7E"
	#define MSG_STOP_PRINT "Detener Impresion \x7E"
	#define MSG_CARD_MENU "Imprimir de SD     \x7E"
	#define MSG_NO_CARD "No hay SD"
	#define MSG_DWELL "Reposo..."
	#define MSG_USERWAIT "esperando Ordenes..."
	#define MSG_RESUMING "continuar impresion"
	#define MSG_NO_MOVE "Sin Movimiento"
	#define MSG_KILLED "PARADA EMERGENCIA"
	#define MSG_STOPPED "PARADA."
	#define MSG_CONTROL_RETRACT  "Retraer mm:"
	#define MSG_CONTROL_RETRACTF "Retraer F:"
	#define MSG_CONTROL_RETRACT_ZLIFT "LevantarZ mm:"
	#define MSG_CONTROL_RETRACT_RECOVER "DesRet +mm:"
	#define MSG_CONTROL_RETRACT_RECOVERF "DesRet  F:"
	#define MSG_AUTORETRACT "AutoRetr.:"
...
// Serial Console Messages
	...
	#define MSG_BED_HEATING "Calentando la mesa."
	#define MSG_BED_DONE "Mesa Caliente."
	#define MSG_M115_REPORT "FIRMWARE_NAME:Marlin V1; Sprinter/grbl mashup for gen6 FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:" PROTOCOL_VERSION " MACHINE_TYPE:" MACHINE_NAME " EXTRUDER_COUNT:" STRINGIFY(EXTRUDERS) "\n"
	#define MSG_COUNT_X " Cuenta X: "
	#define MSG_ERR_KILLED "Impresora Parada con kill()!!"
	#define MSG_ERR_STOPPED "Impresora parada por errores. Arregle el error y use M999 Para reiniciar!. (La temperatura se reestablece. Ajustela antes de continuar)"
